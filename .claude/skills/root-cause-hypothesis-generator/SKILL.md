...
purpose: "Generate plausible root-cause hypotheses from symptoms, recent changes, and system context without overstating certainty."
...
handoffs: ["change-impact-mapper", "regression-risk-reviewer", "rollback-plan-writer"]
---
# root-cause-hypothesis-generator

## Purpose
Generate plausible root-cause hypotheses from symptoms, recent changes, and system context without overstating certainty.
