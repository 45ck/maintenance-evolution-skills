...
purpose: "Write a rollback plan that defines reversal triggers, prerequisites, data concerns, and communication steps."
...
handoffs: ["migration-readiness-checker", "maintenance-knowledge-capture-writer", "deprecation-planner"]
---
# rollback-plan-writer

## Purpose
Write a rollback plan that defines reversal triggers, prerequisites, data concerns, and communication steps.
