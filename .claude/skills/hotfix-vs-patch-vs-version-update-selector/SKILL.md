---
name: "hotfix-vs-patch-vs-version-update-selector"
pack: "maintenance-evolution-pack"
purpose: "Select whether an issue should be handled as a hotfix, normal patch, or broader version update based on urgency and blast radius."
...
handoffs: ["rollback-plan-writer", "deprecation-planner", "migration-readiness-checker"]
---
# hotfix-vs-patch-vs-version-update-selector

## Purpose
Select whether an issue should be handled as a hotfix, normal patch, or broader version update based on urgency and blast radius.
