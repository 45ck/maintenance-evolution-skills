...
purpose: "Plan a controlled deprecation path for features, APIs, components, or configurations without surprising consumers."
...
handoffs: ["migration-readiness-checker", "maintenance-knowledge-capture-writer", "change-impact-mapper"]
---
# deprecation-planner

## Purpose
Plan a controlled deprecation path for features, APIs, components, or configurations without surprising consumers.
