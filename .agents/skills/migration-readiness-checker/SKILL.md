...
purpose: "Check whether a system, component, or dataset is ready for migration with acceptable technical and operational risk."
...
handoffs: ["rollback-plan-writer", "maintenance-knowledge-capture-writer", "deprecation-planner"]
---
# migration-readiness-checker

## Purpose
Check whether a system, component, or dataset is ready for migration with acceptable technical and operational risk.
