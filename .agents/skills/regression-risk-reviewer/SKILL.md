...
purpose: "Review a maintenance change for regression risk and identify the most exposed behaviors, integrations, and environments."
...
handoffs: ["rollback-plan-writer", "hotfix-vs-patch-vs-version-update-selector", "maintenance-knowledge-capture-writer"]
---
# regression-risk-reviewer

## Purpose
Review a maintenance change for regression risk and identify the most exposed behaviors, integrations, and environments.
