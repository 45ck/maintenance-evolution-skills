...
purpose: "Write clear, deterministic bug reproduction steps with environment, data, and expected versus actual behavior."
...
handoffs: ["maintenance-triage-helper", "root-cause-hypothesis-generator", "regression-risk-reviewer"]
---
# bug-reproduction-writer

## Purpose
Write clear, deterministic bug reproduction steps with environment, data, and expected versus actual behavior.
